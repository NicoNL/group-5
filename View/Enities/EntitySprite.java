...
public class EntitySprite extends JComponent {
    ...
    private void drawHealthBar(Graphics2D g2, int screenX, int screenY) {
        ...
        g2.fillRect(screenX, screenY - 20, (int)(map.getTitleSize() * animalController.getCurrentHealth() / animalController.getMaxHealth()), 5);
        g2.setColor(Color.WHITE);
        g2.setFont(new Font("Arial", Font.BOLD, 10));
        g2.drawString(healthPercent + "%", screenX + map.getTitleSize() + 5, screenY - 15);
    }
    ...
    private void drawThirstBar(Graphics2D g2, int screenX, int screenY) {
        ...
        g2.setColor(new Color(0, 191, 255)); // Bright blue
        g2.fillRect(screenX, screenY - 10, (int)(map.getTitleSize() * animalController.getCurrentThirst() / animalController.getMaxThirst()), 5);
        g2.setColor(Color.WHITE);
        g2.drawString(thirstPercent + "%", screenX + map.getTitleSize() + 5, screenY - 5);
    }
    ...
    private void drawHungerBar(Graphics2D g2, int screenX, int screenY) {
        ...
        g2.fillRect(screenX, screenY - 15, (int)(map.getTitleSize() * animalController.getCurrentHunger() / animalController.getMaxHunger()), 5);
        g2.setColor(Color.WHITE);
        g2.drawString(hungerPercent + "%", screenX + map.getTitleSize() + 5, screenY - 10);
    }
